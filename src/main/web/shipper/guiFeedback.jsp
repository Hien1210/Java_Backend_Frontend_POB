...
<div class="bg-white rounded-2xl shadow-lg w-full max-w-lg p-8">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-lg font-extrabold text-gray-800">Đánh giá Cửa hàng</h1>
    ...
    <form action="${pageContext.request.contextPath}/shipper/feedback" method="post">
        ...
        <!-- Sao -->
        <div class="mb-5">
            <p class="text-sm font-semibold text-gray-700 mb-3">Mức độ hài lòng với cửa hàng</p>
        ...
        <!-- Bình luận -->
        <div class="mb-6">
            <label class="block text-sm font-semibold text-gray-700 mb-2">Nhận xét về cửa hàng</label>
            <textarea name="comment" rows="4"
                      placeholder="Đóng gói hàng, thái độ phục vụ, chuẩn bị đơn..."
