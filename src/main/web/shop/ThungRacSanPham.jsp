...
<main class="main">
    ...
    <div class="content">
        ...
        <div>
            <a href="${pageContext.request.contextPath}/shop/products" class="btn btn-ghost">← Quay lại danh sách</a>
        </div>

        <div class="panel">
            <div class="panel-header">
                <div class="panel-title">🗑️ Sản phẩm đã xóa</div>
                <span class="badge badge-neutral">${fn:length(deletedProducts)} mục</span>
            </div>
                ...
                <c:choose>
                    <c:when test="${empty deletedProducts}">
                        <div class="empty-state">
                            ...
                            <div class="e-title">Thùng rác trống — không có sản phẩm nào đã xóa.</div>
                        </div>
                    </c:when>
                    <c:otherwise>
