...
<main class="main">
    ...
    <div class="content">
        ...
        <div>
            <a href="${pageContext.request.contextPath}/shop/toppings" class="btn btn-ghost">← Quay lại danh sách</a>
        </div>

        <div class="panel">
            <div class="panel-header">
                <div class="panel-title">🗑️ Topping đã xóa</div>
                <span class="badge badge-neutral">${fn:length(deletedToppings)} mục</span>
            </div>
                ...
                <c:choose>
                    <c:when test="${empty deletedToppings}">
                        <div class="empty-state">
                            ...
                            <div class="e-title">Thùng rác trống — không có topping nào đã xóa.</div>
                        </div>
                    </c:when>
                    <c:otherwise>
