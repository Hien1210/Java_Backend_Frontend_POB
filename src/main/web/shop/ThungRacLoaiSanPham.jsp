...
<main class="main-content">
    <header class="top-header">
        <h2>🗑️ THÙNG RÁC — LOẠI SẢN PHẨM</h2>
    ...
    <div class="content-wrapper">
        ...
        <div class="back-bar">
            <a href="${pageContext.request.contextPath}/shop/product-types" class="btn-back">← Quay lại danh sách</a>
            <span class="trash-hint">🗑️ Các loại sản phẩm đã xóa — bấm <strong>Khôi phục</strong> để đưa trở lại danh sách.</span>
        </div>

        <div class="panel">
            <div class="panel-header">
                <span class="panel-title">Loại sản phẩm đã xóa</span>
                ...
                <c:choose>
                    <c:when test="${empty deletedCategories}">
                        <div class="empty-state">
                            ...
                            <p>Thùng rác trống — không có loại sản phẩm nào đã xóa.</p>
                        </div>
                    </c:when>
                    <c:otherwise>
                        <table>
