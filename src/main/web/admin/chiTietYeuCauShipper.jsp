...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; transition: background-color 0.3s ease, border-color 0.3s ease, color 0.3s ease; }
        ...
        .info-card { background-color: var(--bg-panel); border-radius: 10px; padding: 24px; border: 1px solid var(--border-color); box-shadow: var(--shadow-md); animation: fadeUp 0.35s ease both; }
        ...
        .btn-approve:hover { background: var(--primary-hover); color: #fff; }
        .btn-reject { background: var(--danger); color: white; }
        .btn-reject:hover { background: #b91c1c; }
        .btn-back { background: #475569; color: white; display: inline-block; margin-bottom: 20px; }
        .btn-back:hover { background: #334155; }

        .badge-pending { background: rgba(245,158,11,0.15); color: var(--warning); border: 1px solid var(--warning); padding: 3px 10px; border-radius: 12px; font-size: 12px; font-weight: 600; }
        ...
        .empty { padding: 30px; background: var(--bg-panel); color: var(--primary); text-align: center; font-size: 15px; border-radius: 10px; border: 1px dashed var(--border-color); animation: fadeUp 0.35s ease both; }
...
<aside class="sidebar">
    ...
    <div class="menu-section">
        ...
        <a href="#" class="menu-item"><div class="menu-item-left"><span style="font-size:16px">📈</span> Báo cáo vận hành</div></a>
        ...
        <a href="#" class="menu-item"><div class="menu-item-left"><span style="font-size:16px">🚩</span> Kiểm duyệt nội dung</div></a>
        ...
        <a href="#" class="menu-item"><div class="menu-item-left"><span style="font-size:16px">💵</span> Đối soát doanh thu Shop</div></a>
        <a href="#" class="menu-item"><div class="menu-item-left"><span style="font-size:16px">💳</span> Duyệt rút tiền Shipper</div></a>
        ...
        <a href="#" class="menu-item"><div class="menu-item-left"><span style="font-size:16px">🛠️</span> Tham số vận hành</div></a>
        <a href="#" class="menu-item"><div class="menu-item-left"><span style="font-size:16px">📢</span> Truyền thông & Banner</div></a>
    </div>
</aside>
