...
<head>
    ...
    <style>
        ...
        .btn-filter { background: var(--primary); color: #0f172a; border: none; padding: 9px 20px; border-radius: 8px; font-size: 13px; font-weight: 800; cursor: pointer; transition: 0.15s; white-space: nowrap; }
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="menu">
        ...
        <a href="${pageContext.request.contextPath}/admin/audit-logs" class="menu-item active">
            <span class="mi-left"><span class="mi-icon">🕒</span> Audit Log</span>
        </a>
    </div>
</aside>
